...
namespace OsDsII.api.Migrations
{
    ...
    [Migration("20240313010831_FullDatabase")]
            ...
            modelBuilder.Entity("OsDsII.api.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("SendDate")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 3, 12, 22, 8, 30, 969, DateTimeKind.Unspecified).AddTicks(1161), new TimeSpan(0, -3, 0, 0, 0)));
            ...
            modelBuilder.Entity("OsDsII.api.Models.ServiceOrder", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("OpeningDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 3, 12, 22, 8, 30, 968, DateTimeKind.Unspecified).AddTicks(4131), new TimeSpan(0, -3, 0, 0, 0)));
